...
packages\Sake\tools\Sake.exe -I packages\KoreBuild\build -f makefile.shade clean
packages\Sake\tools\Sake.exe -I packages\KoreBuild\build -f makefile.shade test
if errorlevel 1 (
    echo Test failed.
    packages\Sake\tools\Sake.exe -I packages\KoreBuild\build -f makefile.shade clean
)
